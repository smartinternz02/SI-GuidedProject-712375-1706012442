...
WebUI.setText(findTestObject('CURA_New_001/variables/Page_CURA Healthcare Service/input_username'), GlobalVariable.username)

WebUI.setText(findTestObject('CURA_New_001/variables/Page_CURA Healthcare Service/input_password'), GlobalVariable.password)
